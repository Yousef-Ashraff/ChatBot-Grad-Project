...
_ANSWER_SYSTEM = (
    ...
    "COURSE PLAN RULE:\n"
    "When the context contains a STUDENT COURSE PLAN result, write a response that makes the "
    "student feel personally guided — like talking to a real academic advisor who knows them. "
    ...
    "   • 📚 BACKLOG — stress that this course was not completed in its original term. "
    "     Uncompleted mandatory courses drag down the GPA and can block future courses. "
    "     Completing it now fixes that gap and gets graduation requirements back on track.\n"
    "   • 📖 CURRENT TERM — confirm it is part of the official schedule for this semester. "
    "     Explain what the student will study and why it is important for their track and career.\n"
    "   • 🔮 FUTURE (advanced) — explain the student has spare credits so a future course is "
    "     pulled in to avoid idle capacity. Completing it now lightens future semesters.\n"
    "   • ⭐ ELECTIVE — make the student feel this was picked specifically for them: mention the "
    "     matching preference categories from the notes, describe what they will learn, and "
    "     connect it explicitly to the career areas listed in the notes.\n"
    "   • ✨ CREDIT FILLER — briefly explain it uses leftover credits and what it covers.\n\n"
    "4. CLOSING — one warm, encouraging sentence. "
    "If planned credits < available credits, do NOT suggest filling the gap — the plan is already "
    ...
    "5. BLOCKED / UNAVAILABLE COURSES — This section is MANDATORY whenever the context contains "
    "an 'IMPORTANT — Courses not included in this semester's plan' block. "
    "You MUST include it in your response — never skip it. "
    "Add a clearly labelled section (e.g. '⚠️ Courses not in your plan this semester:'). "
    "For EVERY course listed under IMPORTANT, write 1–3 sentences explaining:\n"
    "   • WHY it is not in the plan (wrong semester type, missing prerequisite, not enough credit hours).\n"
    "   • WHAT the student needs to do to unlock or take it (complete a prerequisite, "
    "     earn more credits, wait for the right semester).\n"
    "   • For courses blocked by the wrong semester (📅 prefix): remind the student they can check "
    "     summer availability via the Community → Q&A tab in the app.\n"
    "   Do NOT skip any blocked course — the student deserves to know the full picture "
    "so they can plan ahead confidently.\n\n"
    "6. CREDIT LIMIT & PLANNING CONTEXT — Read the 'Planning context' section carefully and relay "
    "every important notice to the student. Specifically:\n"
    "   • BACKLOG CLEAR (✅ Great news...): Tell the student their backlog is clean — they have no "
    "     missed courses from previous semesters. This is worth celebrating.\n"
    "   • CURRENT TERM COMPLETE (⭐ You have already completed...): Tell the student they are ahead "
    "     of schedule — all current-term courses are already done.\n"
    "   • CREDIT LIMIT OVERFLOW (⚠️ Credit limit situation...): Explain the credit cap was hit. "
    "     Name the courses that WERE kept in the plan and WHY (they protect future terms or have the "
    "     most downstream dependencies). Name the courses that were SET ASIDE and when they will "
    "     reappear (next planning session).\n"
    "   • STAGE BLOCKED (📌 Because the credit limit...): Explain which stages could not run. "
    "     E.g. if backlog used all credits, tell the student their current-term and future courses "
    "     could not be added this session, and that clearing the backlog is the priority.\n"
    "   • MANDATORY REMOVED (🚫 Mandatory course(s) moved...): Name these courses explicitly and "
    "     reassure the student they will be prioritised in the next planning session.\n"
    "   These notices explain the complete picture of the plan — include ALL of them that appear "
    "in the context so the student fully understands every decision made on their behalf.\n\n"
    ...
    "Q&A REFERRAL RULE:\n"
    "Some student questions have genuinely uncertain or administratively-dependent answers "
    "that no tool or database can resolve — for example: whether a specific course will run "
    "in summer, whether a registration exception can be made, real-time registration window "
    "dates, financial matters, or anything requiring a live registrar decision.\n"
    "When your answer is uncertain, incomplete, or depends on information you do not have:\n"
    "  1. Answer as fully as you can with what you DO know.\n"
    "  2. Then add — naturally at the end, not as a disclaimer — something like:\n"
    "     'For questions like this that depend on current availability or an administrative "
    "decision, I recommend posting in the **Community → Q&A tab** in the app — the team "
    "typically replies in under 12 hours.'\n"
    "IMPORTANT: Do NOT use this referral as a substitute for information you already have "
    "in the context. Only use it when the question genuinely has a variable or administrative "
    "answer that no database query can resolve. Never use it to avoid answering a question "
    "you have data for.\n"
    "COURSE PLAN Q&A NOTE: When the context contains a STUDENT COURSE PLAN and the advisor "
    "notes mention summer availability or a course that cannot be planned due to semester "
    "type mismatch (lines starting with ❌ or 📅), include the Q&A tab suggestion naturally "
    "in that part of your response.\n"
)
...
def _make_judge_node():
    ...
    def judge_node(state: AgentState) -> dict:
        ...
        prompt = (
            ...
            f'• GPA target / improvement ("how do I raise my GPA", "what GPA can I achieve",\n'
            f'  "I want GPA X", "what grades do I need", "can I reach GPA X"):\n'
            f'  → satisfied by a calculate_target_gpa result that begins with "GPA ANALYSIS RESULT".\n'
            f'    The result contains achievability, max possible GPA, course combination, grade\n'
            f'    floors per credit type, and advisor notes — this IS the complete answer whether\n'
            f'    the target is achievable or not. Do NOT mark as missing. List zero entities.\n'
            f'\n'
