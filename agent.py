...
_AGENT_SYSTEM = (
    ...
    "5. Use the exact course/program names from the query — do NOT substitute.\n"
...
_ANSWER_SYSTEM = (
    ...
    "- If the student asks about 'specialized courses' (no qualifier) → present BOTH "
    "  the specialized core courses AND the specialized elective catalogue.\n"
    "- If the student asks about 'specialized core courses' → present core only.\n"
    "- If the student asks about 'specialized elective courses' → present elective catalogue only.\n\n"
